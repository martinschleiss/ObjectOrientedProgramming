...
public class SoftwareServicetechniker extends Software {
	...
	public String phaseZweiFuegeAndroidZuListeHinzu(TreeMap<Integer, Androide> liste, Sicherheitsstufe s,Servicetechniker se, String out) {
		return s.aufSoftwareServicetechniker(this, se, liste,out);
	}
	...
	public String vonServicetechnikerInstalliert(Servicetechniker se, TreeMap<Integer, Androide> liste){ 
		String out="Software passt, ";
		return phaseZweiFuegeAndroidZuListeHinzu(liste, s,se,out);
	};
