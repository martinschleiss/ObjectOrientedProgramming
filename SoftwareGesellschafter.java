...
public class SoftwareGesellschafter extends Software {
	...
	public String phaseZweiFuegeAndroidZuListeHinzu(TreeMap<Integer, Androide> liste, Sicherheitsstufe s,Gesellschafter g, String out) {
		return s.aufSoftwareGesellschafter(this, g, liste,out);
	}
	...
	public String vonGesellschafterInstalliert(Gesellschafter g, TreeMap<Integer, Androide> liste){ 
		...
		return phaseZweiFuegeAndroidZuListeHinzu(liste, s, g, out);
	};
