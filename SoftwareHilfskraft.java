...
public class SoftwareHilfskraft extends Software {
	...
	public String phaseZweiFuegeAndroidZuListeHinzu(TreeMap<Integer, Androide> liste, Sicherheitsstufe s,Hilfskraft h,String out) {
		return s.aufSoftwareHilfskraft(this, h, liste, out);
	}
	...
	public String vonHilfskraftInstalliert(Hilfskraft h, TreeMap<Integer, Androide> liste){ 
		...
		return phaseZweiFuegeAndroidZuListeHinzu(liste, s,h,out);
	};
