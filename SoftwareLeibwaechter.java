...
public class SoftwareLeibwaechter extends Software {
	...
	public String phaseZweiFuegeAndroidZuListeHinzu(TreeMap<Integer, Androide> liste, Sicherheitsstufe s,Leibwaechter l,String out) {
		return s.aufSoftwareLeibwaechter(this, l, liste,out);
	}
	...
	public String vonLeibwaechterInstalliert(Leibwaechter l, TreeMap<Integer, Androide> liste){ 
		...
		return phaseZweiFuegeAndroidZuListeHinzu(liste, s,l,out);
	};
