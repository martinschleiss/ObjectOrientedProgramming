...
public class SoftwareKaempfer extends Software {
	...
	public String phaseZweiFuegeAndroidZuListeHinzu(TreeMap<Integer, Androide> liste, Sicherheitsstufe s, Kaempfer k,String out) {
		return s.aufSoftwareKaempfer(this, k, liste,out);
	}
	...
	public String vonKaempferInstalliert(Kaempfer k, TreeMap<Integer, Androide> liste){ 
		...
		return phaseZweiFuegeAndroidZuListeHinzu(liste, s,k,out);
	};
